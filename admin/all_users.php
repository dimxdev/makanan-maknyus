                                            ...
                                            if(!mysqli_num_rows($query) > 0 ) {
                                                ...
                                                while($rows=mysqli_fetch_array($query)) {
                                                    echo ' <tr>
                                                            ...
                                                            <td>'.$rows['no_tlp'].'</td>
                                                            <td>'.$rows['alamat'].'</td>
                                                            <td><a href="delete_users.php?user_del='.$rows['id_user'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                                                <a href="update_users.php?user_upd='.$rows['id_user'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
                                                            </td>
                                                        </tr>';
                                                }	
                                            }
